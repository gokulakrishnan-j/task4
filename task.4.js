...
var gokul =new XMLHttpRequest();
gokul.open("GET","https://restcountries.com/v3.1/all");
gokul.send();
gokul.responseType="json";
gokul.onload= function P (){
var flags=gokul.response;
...
// Ⅲ Country Details:
var vasu =new XMLHttpRequest();
vasu.open("GET","https://restcountries.com/v3.1/all");
vasu.send();
vasu.responseType="json";
vasu.onload= function h (){
var country=vasu.response;
...
var file={first_name:"gokulakrishnan", last_name:"j", marital_status:"unmarried", country:"india", age:"21"}
console.log("single line :",JSON.stringify(file));
//5. Declare variables and assign string, boolean, undefined and null data types:
var data_type1="gokul";
